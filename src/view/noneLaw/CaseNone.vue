<template>
  <div class="main-area">
    <el-breadcrumb separator=":">
      ...
      <el-breadcrumb-item>非诉讼类案件</el-breadcrumb-item>
    </el-breadcrumb>
    <!--查询区域-->
    ...
    <el-row class="margin-top-10">
      ...
      <el-col :span="4">
        ...
        <el-button v-if="hasSource(GLOBAL.config.sourceName.emport)" type="primary" @click="exportTableData"
                   :size="GLOBAL.config.systemSize" icon="el-icon-download">导出
        </el-button>
      </el-col>
    </el-row>
    <el-row class="margin-top-20">
        ...
        >
          ...
          <el-table-column prop="serviceType" label="服务类型" align="center">
            <template slot-scope="scope">
              ...
              GLOBAL.config.dictionaryPre + GLOBAL.config.dictionary.serviceType)
              }}
            </template>
          </el-table-column>
          ...
          <el-table-column prop="servicePersonal" label="服务人员" align="center">
            <template slot-scope="scope">
              ...
              <i class="el-icon-s-operation"
                 v-if="hasSource(GLOBAL.config.sourceName.replace)"
                 style="cursor: pointer; color: #409EFF;" title="修改服务人员"
    ...
    data () {
      return {
        ...
        sourceList: JSON.parse(unescape(localStorage.getItem(this.GLOBAL.config.sourceList)))
          ?
          JSON.parse(unescape(localStorage.getItem(this.GLOBAL.config.sourceList))).filter(item => !item.value.indexOf(this.GLOBAL.config.modeName.noneLaw))
          :
          null
      }
    },
    ...
    methods: {
      ...
      exportTableData: function () {
        ...
        this.FUNCTIONS.systemFunction.postDownFile(this, {
          type: 'nonLitigationCasesServiceImpl.downFile',
          info: searchParams
        })
      }
    }
