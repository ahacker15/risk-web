<template>
  <div class="main-area">
    <el-page-header @back="goBack" content="非诉讼类案件新增"></el-page-header>
    <el-form
      :inline="true"
      :model="formData"
      class="demo-ruleForm"
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="律所名称：" prop="lawFirmName"
            ...
            <el-input v-model="formData.lawFirmName" placeholder="律所名称" maxlength="64">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="律师姓名：" prop="lawerName"
            ...
            <el-input v-model="formData.lawerName" placeholder="律师姓名" maxlength="16">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-for="(item, index) in formData.caseProcess" :key="item.id">
        <el-col :span="22">
          <el-form-item :label="'案件进展' + (index?(index+1):'') + '：'"
                        :prop="'caseProcess.' + index + '.content'" :rules="formRules.caseProcess">
            <el-input
              type="textarea"
              autosize
