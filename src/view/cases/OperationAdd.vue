  ...
  <div class="main-area">
    ...
    >
      <el-row class="margin-top-20">
        <el-col :span="8">
          <el-form-item label="流程编号：" >
            <el-input v-model="formData.flowNo" placeholder="系统自动生成" maxlength="64" disabled="disabled"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row v-for="(item, index) in formData.hearInformationList" :key="item.id ? item.id : index">
        ...
        <hearInformation :info-data="item" :key="item.id" ref="hearInformation"/>
      ...
      saveForm: function () {
        this.$refs.formData.validate(valid => {
          if (valid) {
           ...
           ////////// 4、处理服务人员
            this.formData.servicePersonal=this.formData.servicePersonal.join(',')
            // 参数处理======end============
            let _this = this
            _this.loading = true
